<cfcomponent output="false">
	...
	<!------------------------------------------------------------------------------->
	<cffunction name="_setSessionTheme"  access="private" returnType="void" output="false">
		<cfif StructKeyExists(URL,"site_theme") AND StructKeyExists(URL,"page") AND Trim(URL.page) NEQ "">
			<cfswitch expression="#URL.site_theme#">
				<cfcase value="1">
					<cfset _setTheme("w") />
				</cfcase>
				<cfdefaultcase>
	...
	<cffunction name="_setTheme"  access="private" returnType="void" output="false">
		...
		<cfset SESSION.url_theme_admin = "#APPLICATION.url_web#themes/#SESSION.folder_name_theme_admin#/">
		<cfset SESSION.absolute_url_theme_admin = "#APPLICATION.absolute_url_web#themes/#SESSION.folder_name_theme_admin#/">
		<cfset SESSION.absolute_path_theme_admin = "#APPLICATION.absolute_path_root#themes\#SESSION.folder_name_theme_admin#\">
	</cffunction>
	<!------------------------------------------------------------------------------->
