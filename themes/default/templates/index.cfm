		...
		<ul>
			<cfloop from="1" to="#ArrayLen(REQUEST.pageData.categoryTree)#" index="i">
				...
				<li class="<cfif ArrayLen(cat.getSubCategories()) NEQ 0>has-sub-menu</cfif> first-level-menu" <cfif i EQ 1>style="margin-top:6px;<cfelseif i EQ ArrayLen(REQUEST.pageData.categoryTree)>style="margin-bottom:6px;</cfif>">
					<a href="#APPLICATION.absoluteUrlWeb#products.cfm/#URLEncodedFormat(cat.getDisplayName())#/#cat.getCategoryId()#/1/0/">#cat.getDisplayName()#</a>
						...
						<div class="cat-submenu">
							<div style="z-index:1;position: relative;">
								<cfloop array="#cat.getSubCategories()#" index="subCat">
									<dl>
										<div class="clear"></div>
										<dt><a href="#APPLICATION.absoluteUrlWeb#products.cfm/#URLEncodedFormat(subCat.getDisplayName())#/#subCat.getCategoryId()#/1/0/">#subCat.getDisplayName()#</a></dt>
										<cfloop array="#subCat.getSubCategories()#" index="thirdCat">
											<dd><a href="#APPLICATION.absoluteUrlWeb#products.cfm/#URLEncodedFormat(thirdCat.getDisplayName())#/#thirdCat.getCategoryId()#/1/0/">#thirdCat.getDisplayName()#</a></dd>
										</cfloop>
									</dl>
								</cfloop>
								<div class="clear"></div>
	...
	<div class="container">
		<div id="category-list">
			<div class="cat-thumbnails">
				<div class="cat-thumbnail-title"><a href="#APPLICATION.absoluteUrlWeb#products.cfm/#URLEncodedFormat(REQUEST.pageData.topSellingCategory.getDisplayName())#/#REQUEST.pageData.topSellingCategory.getCategoryId()#/1/0/">#REQUEST.pageData.topSellingCategory.getDisplayName()#</a></div>
			...
			<div class="cat-thumbnails">
				<div class="cat-thumbnail-title"><a href="#APPLICATION.absoluteUrlWeb#products.cfm/#URLEncodedFormat(REQUEST.pageData.groupBuyingCategory.getDisplayName())#/#REQUEST.pageData.groupBuyingCategory.getCategoryId()#/1/0/">#REQUEST.pageData.groupBuyingCategory.getDisplayName()#</a></div>
