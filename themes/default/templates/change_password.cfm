		...
		<div>
			<table id="current-address-table" class="shipping-address-selected" style="width:100%;margin-top:20px;">
				...
				<tr>
					...
					<td>
						<input name="current_password" id="current_password" type="text" maxlength="100" size="25" style="width:180px;">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input name="new_password" id="new_password" type="text" maxlength="40" size="25" style="width:180px;">
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<input name="confirm_new_password" id="confirm_new_password" type="text" maxlength="40" size="25" style="width:180px;">
					</td>
				</tr>
