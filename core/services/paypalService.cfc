<cfcomponent output="false" accessors="true">
	...
	<cffunction name="process" output="false" access="private" returntype="array">
		...
		<cfset LOCAL.requestData.ReturnURL = "#APPLICATION.urlHttpsWeb#payments/paypal.cfm">
		...
		<cfelse>
			...
			<cflocation  url="#APPLICATION.absoluteUrlWeb#checkout/checkout_confirmation.cfm" addtoken="false">
			--->
		</cfif>
    </cffunction>
</cfcomponent>