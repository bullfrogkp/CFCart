<cfcomponent extends="entity" persistent="true"> 
    ...
    <cfproperty name="imageIsEnabled" column="image_is_enabled" ormtype="boolean" default="true"> 
    <cfproperty name="imageIsDeleted" column="image_is_deleted" ormtype="boolean" default="false"> 
	<cfproperty name="imageDescription" column="image_description" ormtype="string" default=""> 
