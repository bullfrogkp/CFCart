<cfcomponent output="false" mappedsuperclass="true" accessors="true"> 
    ...
    <cfproperty name="displayName" column="display_name" ormtype="string" default=""> 
	<cfproperty name="description" column="description" ormtype="string" default=""> 
    <cfproperty name="isEnabled" column="is_enabled" ormtype="boolean" default="true"> 
    <cfproperty name="isDeleted" column="is_deleted" ormtype="boolean" default="false"> 
