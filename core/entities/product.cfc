<cfcomponent extends="entity" persistent="true"> 
	...
	<cfproperty name="categoryId" column="category_id" ormtype="integer" default="-1"> 
	<cfproperty name="title" column="title" ormtype="string" default=""> 
	<cfproperty name="keywords" column="keywords" ormtype="string" default=""> 
	<cfproperty name="detail" column="detail" ormtype="text" default=""> 
	<cfproperty name="attributeSetId" column="attribute_set_id" ormtype="integer" default="-1"> 
	...
	<cfproperty name="otherCategories" fieldtype="many-to-many" cfc="category" linktable="category_product_rela" fkcolumn="product_id" inversejoincolumn="category_id" orderby="productId">
